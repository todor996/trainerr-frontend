...
async function lazyLoadResource({ folderName, namespace }: { folderName: string, namespace: string }) {
 ...
 */
export function lazyLoadResourceHook({ folderName, namespace }: { folderName: string, namespace: string }) {
    useEffect(() => {
