...
export function PresentationSection(): JSX.Element {
  return (
    <div className="hidden gap-4 bg-base-200 py-6 lg:flex lg:flex-col lg:items-center">
      <h2 className="text-3xl font-semibold text-base-content lg:flex lg:flex-col lg:items-center lg:justify-center">
        <span>Your App</span>
        <span>Your Logo</span>
